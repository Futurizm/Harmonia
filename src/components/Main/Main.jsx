                ...
                {!showResult ? (
                    ...
                    <div className='result'>
                        <div className="result-title">
                            <img src={assets.user_icon} alt="" />
                            <p className='oru'>{recentPrompt}</p>
                        </div>
                        <div className="result-data">
                            ...
                            {loading ? (
                                ...
                                <p className='ugu' dangerouslySetInnerHTML={{ __html: resultData }}></p>
                            )}
                        </div>
                    </div>
                )}
...
<div className="main-bottom">
    <div className="search-box">
        <input 
            ...
            onKeyPress={(e) => {
                if (e.key === 'Enter' && input.trim() !== '') { // Проверка на наличие введенных символов, отличных от пробелов
                    onSent();
                }
            }}
        />                        
        <div>
            ...
            {input.trim() !== '' ? <img onClick={() => onSent()} src={assets.send_icon} alt="" /> : null } {/* Проверка на наличие введенных символов, отличных от пробелов */}
        </div>
    </div>
